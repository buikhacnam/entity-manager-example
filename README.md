Using `EntityManager` to query data from database. In this example, we use `MySQL` database. You can change to other database by changing `application.properties` file.
